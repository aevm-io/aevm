...
import (
	...
	"github.com/aevm-io/aevm/crypto/signify"
	"github.com/aevm-io/aevm/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/aevm-io/aevm/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/aevm-io/aevm/internal/version.gitDate="+env.Date)
	}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/aevm-io/aevm/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/aevm-io/aevm/mobile")
